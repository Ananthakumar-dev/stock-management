...
const Form = () => {
    ...
    const handleInputChange = (e) => {
        ...
        // Fetch item details when item_id changes
    ...
    const fetchItemDetails = async (itemId) => {
        try {
            const fetchItemUrl = route("inventories.itemDetails", itemId);
            const response = await axios.get(fetchItemUrl);
            setItemDetails(response.data); // Store item details
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(inventoryStoreUrl, form);
